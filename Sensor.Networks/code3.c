...
#define IEEE802154_TXPOWER_VALUE_MIN (-18) // Minimum transmission power value
...
{
    ESP_LOGI(TAG, "LOST - Device out of Zigbee network");
    // Additional actions for alarm handling can be added here
}
...
void esp_zb_app_signal_handler(esp_zb_app_signal_t *signal_struct)
{
    ...
    switch (sig_type) {
        ...
        default:
            ...
            handle_alarm(); // Trigger alarm for unknown signals
            break;
    }
}
